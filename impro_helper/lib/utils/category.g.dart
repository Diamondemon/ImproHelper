...
const CategorySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'energy': PropertySchema(
      ...
      name: r'energy',
      type: IsarType.byte,
      enumMap: _CategoryenergyEnumValueMap,
    ),
    r'energyString': PropertySchema(
      id: 2,
      name: r'energyString',
      type: IsarType.string,
    ),
...
int _categoryEstimateSize(
  ...
  bytesCount += 3 + object.energyString.length * 3;
...
void _categorySerialize(
  ...
  writer.writeString(offsets[2], object.energyString);
...
Category _categoryDeserialize(
  ...
  final object = Category(
    ...
    energy: _CategoryenergyValueEnumMap[reader.readByteOrNull(offsets[1])] ??
        Energy.low,
...
P _categoryDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_CategoryenergyValueEnumMap[reader.readByteOrNull(offset)] ??
          Energy.low) as P;
    case 2:
...
const _CategoryenergyEnumValueMap = {
  'low': 0,
  'medium': 1,
  'high': 2,
};
const _CategoryenergyValueEnumMap = {
  0: Energy.low,
  1: Energy.medium,
  2: Energy.high,
};
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyEqualTo(
      Energy value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'energy',
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyGreaterThan(
    Energy value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyLessThan(
    Energy value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyBetween(
    Energy lower,
    Energy upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyStringEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'energyString',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyStringLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyStringBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyStringEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyStringContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> energyStringMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortByEnergy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByEnergyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.desc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByEnergyString() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyString', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByEnergyStringDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyString', Sort.desc);
    });
  }
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByEnergy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByEnergyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energy', Sort.desc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByEnergyString() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyString', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByEnergyStringDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'energyString', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByEnergy() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'energy');
    });
  }

  QueryBuilder<Category, Category, QDistinct> distinctByEnergyString(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'energyString', caseSensitive: caseSensitive);
    });
  }
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, Energy, QQueryOperations> energyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'energy');
    });
  }

  QueryBuilder<Category, String, QQueryOperations> energyStringProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'energyString');
    });
  }
